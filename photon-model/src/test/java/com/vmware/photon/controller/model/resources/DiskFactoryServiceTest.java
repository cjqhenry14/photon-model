...
public class DiskFactoryServiceTest {
    ...
    public void setUpTest() {
        this.diskFactoryService = new DiskFactoryService();
    }
    ...
    public void testServiceOptions() {
        ...
        assertThat(this.diskFactoryService.getOptions(), is(expected));
    }

    @Test
    public void testCreateServiceInstance() throws Throwable {
        Service service = this.diskFactoryService.createServiceInstance();
