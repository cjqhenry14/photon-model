...
public class AWSUtils {
    ...
    public static void sendNetworkFinishPatch(StatelessService service, URI taskLink) {

        ProvisionNetworkTaskService.ProvisionNetworkTaskState pn =
    ...
    /*
     * Synchronous call to AWS to create tags for the specified resources
     * The list of tags will be applied to all provided resources
     *
     */
    ...
    /*
     * An AWS Resource name is actually a Tag that must be applied to a resource.
     * This helper method will take an AWS resourceID and Name and apply that as a tag
     *
     */
    public static void setResourceName(String resourceID, String name, AmazonEC2AsyncClient client) {
        Tag awsName = new Tag()
                .withKey(AWS_TAG_NAME)
                .withValue(name);
    ...
    public static List<TagDescription> getResourceTags(String resourceID, AmazonEC2AsyncClient client) {
        Filter resource = new Filter()
                .withName(AWS_FILTER_RESOURCE_ID)
